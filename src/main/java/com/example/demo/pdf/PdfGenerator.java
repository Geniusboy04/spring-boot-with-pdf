...
public class PdfGenerator {
    ...
    public void generate(List<Movie> movieList, HttpServletResponse response) throws DocumentException, IOException {
        ...
        // Creating paragraph
        Paragraph paragraph1 = new Paragraph("List of the Movies", fontTiltle);
        ...
        table.addCell(cell);
        cell.setPhrase(new Phrase("Genera", font));
        table.addCell(cell);
